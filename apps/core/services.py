"""
Core app services — shared business logic and integrations.
"""
...
def emit_platform_webhook(event: str, payload: dict[str, Any] | None = None) -> bool:
    """
    Emit a platform webhook event to the configured URL.

    Returns True if the webhook was delivered successfully (2xx).
    Returns False if no URL is configured or delivery failed.
    """
